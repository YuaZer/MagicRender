...
object BillboardRenderBackend {
    ...
    private fun renderGroup(texture: String, meshes: List<BillboardMesh>, cameraPosition: Vec3) {
    ...
    private data class BillboardRenderKey(
        val texture: String,
